package com.haofan.algorithm.leetcodecn.hard.sort;

class SortSolutionHard {
    public static void main(String args[]) {
        SortSolutionHard solution = new SortSolutionHard();
        int[] nums1 = {1, 3};
        int[] nums2 = {2, 4};
        System.out.println("题目1： " + solution.findMedianSortedArrays(nums1, nums2));
    }

    // 参考：https://cloud.tencent.com/developer/article/1451073
